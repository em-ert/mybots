...
ADDITIONAL_DETAILS = "1 mutation, FPB scaled exp function, EXP_PUNSISH + AGE: if stepsToClick >= 0 and stepValue > 0: self.fitness += (((2-stepsToClick)**2)+0.5); else: self.fitness -= stepValue * 0.5"
# Can be COS, EXP, or EXP_PUNISH
FIT_FUNCTION = "EXP_PUNISH"
