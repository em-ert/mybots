...
class ANALYZE:
    ...
    def Run_Analysis(path, fitness=True, steps=True, bar=True, rand=True):
        ...
        if rand == True:
            ...
            ax3.hist(bestFitness, label="Best Solution", orientation="horizontal", color = "red", height=0.5, alpha=1.0, linewidths=10, linelengths=10)
...
ANALYZE.Run_Analysis("bestRuns/50sols_50gens/run69/", bar=False)