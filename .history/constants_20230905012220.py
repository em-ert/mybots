...
ADDITIONAL_DETAILS = "1 mutation, FPB scaled cos function, 1 leg watched only: (framesPerBeat * np.cos(((2*np.pi)/framesPerBeat)*timestep)) and maximized auditory neurons"
