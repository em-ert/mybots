...
ADDITIONAL_DETAILS = "Specifically for random bots: run with cos function times 10: (10*np.cos(((2*np.pi)/framesPerBeat)*timestep)) and maximized auditory neurons"
