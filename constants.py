...
CHECKPOINT_EVERY = 5
BODY = "Capsule Bot"
ADDITIONAL_DETAILS = "Test run with auditory neuron connected directly to motor neurons and auditory neurons maximized, MOOP w/ fitness and distance moved from origin"
