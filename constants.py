...
SEED = 0
NUMBER_OF_GENERATIONS = 251
POPULATION_SIZE = 100

CHECKPOINT_EVERY = 10
NUM_PARALLEL_RUN_GROUPS = 5
NUM_RANDOM_SIMS_FOR_GRAPHING = 0    # If 0, first gen will just be used

BODY = "Capsule Bot"
BODY_SIZE = 1
TRAVEL_PER_CLICK_GOAL = BODY_SIZE / 8
DOUBLE_STEP_PUNISHMENT = 0.01

#REVIEW - [3] Edit fitness function here
ADDITIONAL_DETAILS = "AFPO with dist * balance * entrainment"
